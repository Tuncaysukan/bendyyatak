...
<head>
    ...
    <title>Giriş Yap — BendyyYatak</title>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .alert-success{background:#dcfce7;border:1px solid #bbf7d0;border-radius:8px;padding:11px 14px;color:#15803d;font-size:13px;margin-bottom:16px;}
    </style>
</head>
<body>
<div class="header">
...
<div class="auth-wrap">
    <div class="auth-card">
        ...
        <div class="auth-sub">Hesabınıza giriş yapın</div>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group">
                <label class="form-label" style="display:flex;align-items:center;justify-content:space-between;">
                    Şifre
                    <a href="{{ route('password.request') }}" style="font-weight:400;color:#6b7280;font-size:12px;">Şifremi Unuttum</a>
                </label>
                <div class="input-wrap">
